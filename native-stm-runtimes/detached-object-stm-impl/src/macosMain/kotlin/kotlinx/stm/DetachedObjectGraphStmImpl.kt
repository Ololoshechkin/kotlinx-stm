...
typealias Delegate = DetachedObjectGraphStmImpl.NativeDelegate<*>

class DetachedObjectGraphStmImpl : STM() {
    ...
    override fun <T> wrap(initValue: T): UniversalDelegate<T> = NativeDelegate(initValue, this)

    @Suppress("UNCHECKED_CAST")
    class NativeDelegate<T>(override val stm: DetachedObjectGraphStmImpl) : UniversalDelegate<T> {
        ...
        constructor(initValue: T, stm: DetachedObjectGraphStmImpl) : this(stm) {
            initValue.freeze()
